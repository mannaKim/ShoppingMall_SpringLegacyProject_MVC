		...
		<table id="list">
			...
			<tr>
				...
				<td width="343" colspan="5">
					<input type="text" name="name" size="47" value="${productVO.name}">
				</td>
			</tr>
			<tr>
				<th>원가[A]</th>
				<td width="70">
					<input type="text" name="price1" size="11" value="${productVO.price1}" onkeyup="cal();">
				</td>
				<th>판매가[B]</th>
				<td width="70">
					<input type="text" name="price2" size="11" value="${productVO.price2}"  onkeyup="cal();">
				</td>
				<th>[B-A]</th>
			...
			<tr>
				...
				<td colspan="5">
					...
					<br>
					<input type="file" name="image"> * 주의 : 이미지를 수정할때에만 선택해주세요</td>
			</tr>
		</table>
		<input class="btn" type="button" value="수정" onClick="go_mod_save()">
		<input class="btn" type="button" value="취소" onClick="go_detail('${productVO.pseq}')">
	</form>
</article>
