...
insert into member(id, pwd, name, zip_num, address1, phone, email) values
...
values(qna_seq.nextval, '배송이 많이 지연되고 있습니다', '언제 받을 수 있나요', 'one');
...
m.name as mname, m.zip_num, m.address1, m.address2, m.address3, m.phone, 
